...
<h2>Chat Room(Department only)</h2>
	<div class="form-group">
		<div style="height: 520px; overflow-y: scroll; " id="chatView">
			<c:forEach var="d" items="${depchatlist }">
				<div class="alert alert-primary" role="alert">
					<small>【 ${d.user.DNAME } 】 【 ${d.user.PNAME } ${d.user.NAME } 】</small><br/>
						${d.text }
				</div>
			</c:forEach>
		</div>
...
<script>
	var chatws = new WebSocket("ws://"+ location.host + "${pageContext.servletContext.contextPath}/depchat.do");
	...
	var deppublicHandle = function(obj) {
		var txt = obj.text
	...
	document.getElementById("input").onchange = function() {
		...
		var msg = {"mode" : "deppublic", "text" : this.value};
